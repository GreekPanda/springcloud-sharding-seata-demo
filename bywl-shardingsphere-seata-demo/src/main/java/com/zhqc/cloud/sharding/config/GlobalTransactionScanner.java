package com.zhqc.cloud.sharding.config;
        ...
        try {
            synchronized (PROXYED_SET) {
                ...
                if (TCCBeanParserUtils.isTccAutoProxy(bean, beanName, applicationContext)) {
                    ...
                    interceptor = (MethodInterceptor) new TccActionInterceptor(TCCBeanParserUtils.getRemotingDesc(beanName));
                } else {
                    ...
                    if (interceptor == null) {
                        interceptor = (MethodInterceptor) new GlobalTransactionalInterceptor(failureHandlerHook);
                    }
                }
